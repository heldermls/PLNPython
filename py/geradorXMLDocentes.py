...
regex = r"\n(([a-zA-Zá-úÁ-Ú]|\s|\’|\-)*)\((.*)\)"
with open('../txt/Docentes.txt', encoding="utf8") as f:
    txt = f.read()
...
for matchNum, match in enumerate(matches):
    ...
    for groupNum in range(0, len(match.groups())):
        ...
        if groupNum == 3 and match.group(groupNum) != None and match.group(groupNum) !="" :
...
with io.open("../xml/Docentes.xml", "w+", encoding="utf-8") as f:
    f.write(formatedXML)
