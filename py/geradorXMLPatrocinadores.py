...
root = et.Element('patrocinadores')
tree = et.ElementTree(root)
with open('../txt/Patrocinadores.txt', encoding="utf8") as f:
    txt = f.read()
...
for line in lines:
    ...
    if not line or bool(re.match(r'\s\s*', line)):
        ...
        patroninador = et.SubElement(root, "patrocinador")
        patroninador.text = line
...
with io.open("../xml/Patrocinadores.xml", "w+", encoding="utf-8") as f:
    f.write(formatedXML)
